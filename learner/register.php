...
<title>Sign Up - LearnSpace</title>
...
.auth-card { background:white; border-radius:24px; padding:40px; width:100%; max-width:480px; box-shadow:0 20px 60px rgba(0,0,0,0.1); border:1px solid var(--gray-border); }
...
<div class="auth-page">
  <div class="auth-card">
    ...
    <div class="role-tabs">
      <a href="register.php" class="role-tab active">🎓 Learner</a>
      <a href="../instructor/register.php" class="role-tab">👨‍🏫 Instructor</a>
    </div>
